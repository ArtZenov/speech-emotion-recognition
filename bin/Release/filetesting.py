import pickle  # сохранение модели после обучения
import wave
...
import numpy as np
import pyaudio
import soundfile  # чтобы считать аудиофайл
...
# из utils импортируем extract_feature
...
def main():
    ...
    filename = "03-01-03-01-01-01-16.wav"
